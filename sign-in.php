...
session_start();
page_header('Sign in | IDME ','Register to get your id card');
message_display();
?>
...
<div class="page">
    <div class="auth-wrapper">
        ...
        <form action="php/loginscript.php" method="POST">
            ...
            <div class="submitBtn">
                <p class="mt-4 text-center">Have an account?<a href="auth.php">Sign up</a></p>
                <button name="sign-in">Continue</button>
            </div>
        </form>
    </div>
</div>
